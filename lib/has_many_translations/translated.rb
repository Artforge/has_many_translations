module HasManyTranslations
  # Simply adds a flag to determine whether a model class is translated.
  module Translated
    ...
    # For all ActiveRecord::Base models that do not call the +translated+ method, the +translated?+
